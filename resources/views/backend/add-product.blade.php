                    ...
                    <div class="main-content">
                        ...
                        @endif
                            ...
                            @endif --}}
                                ...
                                <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data" action="{{ url('/add-product')}}">
@csrf
                                    ...
                                    <div class="wg-box">
                                        ...
                                        <fieldset class="name">
                                            ...
                                            <input class="mb-10" type="text" placeholder="Enter product name" name="product_name" tabindex="0" value="" aria-required="true" required="" value="{{old('product_name')}}" >
                                        ...
                                        <fieldset class="name">
                                            ...
                                            <input class="mb-10" type="text" placeholder="Enter slug" name="slug" tabindex="0" aria-required="true" required="" value="{{old('slug')}}" >
                                        ...
                                        <div class="gap22 cols">
                                            ...
                                            <fieldset class="category">
                                                <div class="body-title mb-10">Type (required) <span class="tf-color-1">*</span></div>
                                                <div class="select">
                                                    <select class="category_name" name="type" value="{{old('type')}}">
                                        ...
                                        <fieldset class="name">
                                            <div class="body-title mb-10">Brand (required) <span class="tf-color-1">*</span></div>
                                            <input class="mb-10" type="text" placeholder="Enter product name" name="brand" tabindex="0" value="" aria-required="true" required="" value="{{old('brand')}}" >
                                            <div class="text-tiny">Do not exceed 20 characters when entering the product name.</div>
                                            @if ($errors->has('brand'))
                                            <span class="text-danger">
                                                {{$errors->first('brand')}}
                                        ...
                                        <fieldset class="brand">
                                            ...
                                            <div class="select" name="status" value="{{old('status')}}">
                                                <select class="" name="status" value="{{old('status')}}">
                                        ...
                                        <fieldset class="name">
                                            ...
                                            <input class="mb-10" type="number" placeholder="Enter product name" name="price" tabindex="0" value="" aria-required="true" required="" value="{{old('price')}}" >
                                        ...
                                        <fieldset class="name">
                                            ...
                                            <input class="mb-10" type="Number" placeholder="Enter product quantity" name="quantity" tabindex="0" value="" aria-required="true" required="" value="{{old('quantity')}}" >
                                        ...
                                        <fieldset class="">
                                            ...
                                            <textarea class="mb-10" name="description" value="{{old('description')}}" placeholder="Description" tabindex="0" aria-required="true" required=""></textarea>
                                    ...
                                    <div class="wg-box">
                                            ...
                                            <div class="upload-image mb-16">
                                                ...
                                                <div class="item up-load">
                                                    <label class="uploadfile" for="myFile">
                                                        ...
                                                        <input type="file" id="myFile" name="image1" value="{{old('image1')}}">
                                                    </label>
                                        ...
                                        <div class="item up-load">
                                            <label class="uploadfile" for="myFile">
                                                ...
                                                <span class="text-tiny">Drop your images here or select <span class="tf-color">click to browse</span></span>
                                                <input type="file" id="myFile" name="image2" value="{{old('image2')}}">
                                            </label>
                                        ...
                                        <div class="item up-load">
                                            <label class="uploadfile" for="myFile">
                                                ...
                                                <span class="text-tiny">Drop your images here or select <span class="tf-color">click to browse</span></span>
                                                <input type="file" id="myFile" name="image3" value="{{old('image3')}}">
                                            </label>
