...
<!-- Mirrored from themesflat.co/html/remos/index by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Apr 2024 19:37:59 GMT -->
...
<head>
    ...
    <!-- Theme Style -->
    <link rel="stylesheet" type="text/css" href="/backend/css/animate.min.css">
    <link rel="stylesheet" type="text/css" href="/backend/css/animation.css">
    <link rel="stylesheet" type="text/css" href="/backend/css/bootstrap.css">
    <link rel="stylesheet" type="text/css" href="/backend/css/bootstrap-select.min.css">
    <link rel="stylesheet" type="text/css" href="/backend/css/style.css">



    <!-- Font -->
    <link rel="stylesheet" href="/backend/font/fonts.css">

    <!-- Icon -->
    <link rel="stylesheet" href="/backend/icon/style.css">

    <!-- Favicon and Touch Icons  -->
    <link rel="shortcut icon" href="/backend/images/favicon.ico">
    <link rel="apple-touch-icon-precomposed" href="/backend/images/favicon.ico">
        ...
        <div id="page" class="">
            ...
            <div class="layout-wrap">
                ...
                <div class="section-menu-left">
                    <div class="box-logo">
                        <a href="{{ url('/adminhome') }}" id="site-logo-inner">
                            <img class="" id="logo_header" alt="" src="/backend/images/logo/mainlogo.png"
                                ...
                                <li class="menu-item has-children active">
                                    ...
                                    <ul class="sub-menu" style="display: block;">
                                        <li class="sub-menu-item">
                                            <a href="{{ url('/adminhome') }}" class="active">
                            ...
                            <ul class="menu-list">
                                ...
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="sub-menu-item">
                                            <a href="{{ url('/add-attributes') }}" class="">
                                ...
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                            <a href="{{ url('/oder-list') }}" class="">
                                                <div class="text">Order list</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                            <a href="{{ url('/oder-detail') }}" class="">
                                                <div class="text">Order detail</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                            <a href="{{ url('/oder-tracking') }}" class="">
                                ...
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                            <a all-userlhref="{{ url('/all-user') }}" class="">
                    ...
                    <div class="bot text-center">
                        <div class="wrap">
                            <div class="mb-20">
                                <img src="/backend/images/menu-left/img-bot.png" alt="">
                            </div>
                            <div class="mb-20">
                            ...
                            <div class="header-left">
                                <a href="{{ url('/adminhome') }}">
                                    <img class="" id="logo_header_mobile" alt=""
                                        src="/backend/images/logo/logo.png" data-light="images/logo/logo.png"
                                                ...
                                                <ul>
                                                    <li class="product-item gap14 mb-10">
                                                        <div class="image no-bg">
                                                            <img src="/backend/images/products/17.png" alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                                <a href="{{ url('/product-list') }}"
                                                                    class="body-text">Dog Food Rachael Ray Nutrish®</a>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li class="mb-10">
                                                    ...
                                                    <li class="product-item gap14 mb-10">
                                                        <div class="image no-bg">
                                                            <img src="/backend/images/products/18.png" alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                                <a href="{{ url('/product-list') }}"
                                                                    class="body-text">Natural Dog Food Healthy Dog
                                                                    Food</a>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    ...
                                                    <li class="product-item gap14">
                                                        <div class="image no-bg">
                                                            <img src="/backend/images/products/19.png" alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                                <a href="{{ url('/product-list') }}"
                                                                    class="body-text">Freshpet Healthy Dog Food and
                                                                    Cat</a>
                                                            </div>
                                                        </div>
                                                    </li>
                                        ...
                                        <ul class="">
                                            ...
                                            <li>
                                                <ul>
                                                    <li class="product-item gap14 mb-10">
                                                        <div class="image no-bg">
                                                            <img src="/backend/images/products/20.png" alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                                <a href="{{ url('/product-list') }}"
                                                                    class="body-text">Sojos Crunchy Natural Grain
                                                                    Free...</a>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    ...
                                                    <li class="product-item gap14 mb-10">
                                                        <div class="image no-bg">
                                                            <img src="/backend/images/products/21.png" alt="">
                                                        </div>
                                                        ...
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                                <a href="{{ url('/product-list') }}"
                                                                    class="body-text">Kristin Watson</a>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    ...
                                                    <li class="product-item gap14 mb-10">
                                                        <div class="image no-bg">
                                                            <img src="/backend/images/products/22.png" alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                                <a href="{{ url('/product-list') }}"
                                                                    class="body-text">Mega Pumpkin Bone</a>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li class="mb-10">
                                                    ...
                                                    <li class="product-item gap14">
                                                        <div class="image no-bg">
                                                            <img src="/backend/images/products/23.png" alt="">
                                                        </div>
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                                <a href="{{ url('/product-list') }}"
                            ...
                            <div class="header-grid">
                                <div class="header-item country">
                                    <select class="image-select no-text">
                                        <option data-thumbnail="/backend/images/country/1.png">ENG</option>
                                        <option data-thumbnail="/backend/images/country/9.png">VIE</option>
                                    </select>
                                </div>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end has-content"
                                            ...
                                            <li>
                                                <div class="noti-item w-full wg-user active">
                                                    <div class="image">
                                                        <img src="/backend/images/avatar/user-11.png" alt="">
                                                    </div>
                                                    <div class="flex-grow">
                                            ...
                                            <li>
                                                <div class="noti-item w-full wg-user active">
                                                    <div class="image">
                                                        <img src="/backend/images/avatar/user-12.png" alt="">
                                                    </div>
                                                    <div class="flex-grow">
                                                        <div class="flex items-center justify-between">
                                            ...
                                            <li>
                                                <div class="noti-item w-full wg-user active">
                                                    <div class="image">
                                                        <img src="/backend/images/avatar/user-13.png" alt="">
                                                    </div>
                                                    <div class="flex-grow">
                                                        <div class="flex items-center justify-between">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end has-content"
                                            ...
                                            <li>
                                                <ul class="list-apps">
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="/backend/images/apps/item-1.png" alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="/backend/images/apps/item-2.png" alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="/backend/images/apps/item-3.png" alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="/backend/images/apps/item-4.png" alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="/backend/images/apps/item-5.png" alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="/backend/images/apps/item-6.png" alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="/backend/images/apps/item-7.png" alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="/backend/images/apps/item-8.png" alt="">
                                                        </div>
                                                        <a href="#">
                                                    ...
                                                    <li class="item">
                                                        <div class="image">
                                                            <img src="/backend/images/apps/item-9.png" alt="">
                                                        </div>
                                                        <a href="#">
                                    ...
                                    <div class="dropdown">
                                        <button class="btn btn-secondary dropdown-toggle" type="button"
                                            ...
                                            <span class="header-user wg-user">
                                                ...
                                                @if (session()->has('admin_id'))
                                                    <span class="image">
                                                        <img src="{{ session('picture', '/backend/images/avatar/user-1.png') }}"
                                                            alt="">
                                                    </span>

                                                    <span class="flex flex-column">
                                                        <span
                                                            class="body-title mb-2">{{ session('fullname', 'not logged in') }}</span>
                                                        <span class="text-tiny">{{ session('type', '?') }}</span>
                                                    </span>
                                                @else
                                                    <span class="image">
                                                        <img src="/backend/images/avatar/user-1.png" alt="">
                                                    </span>

                                                    <span class="flex flex-column">
                                                        <span class="body-title mb-2">No user</span>
                                                        <span class="text-tiny">Please login</span>
                                                    </span>
                                                @endif
                                            </span>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end has-content"
                                            ...
                                            <li>
                                                <a href="{{ url('/setting') }}" class="user-item">
                                                    <div class="icon">
                                            ...
                                            <li>
                                                <a href="{{ url('/admin/login') }}" class="user-item">
                                                    <div class="icon">
