        ...
        <div id="page" class="">
            <div class="wrap-login-page sign-up">
                ...
                @endif
                        ...
                        <form class="form-login flex flex-column gap24" action = "/admin/register" method="POST" enctype="multipart/form-data">
@csrf
                            <fieldset class="name">
                                <div class="body-title mb-10">Name <span class="tf-color-1">*</span></div>
                                <input class="flex-grow" type="text" placeholder="Enter your name" name="fullname" tabindex="0" value="{{old('fullname')}}" aria-required="true" required="">
                            </fieldset>

                            {{-- <fieldset class="phone">
                                <div class="body-title mb-10">Phone Number <span class="tf-color-1">*</span></div>
                                <input class="flex-grow"  type="number" placeholder="Enter your Phone Number" name="phone" tabindex="0" value="" aria-required="true" required="">
                            </fieldset> --}}

                            <fieldset class="email">
                                <div class="body-title mb-10">Email address <span class="tf-color-1">*</span></div>
                                <input class="flex-grow" type="email" placeholder="Enter your email address" name="email" value="{{old('email')}}" tabindex="0"  aria-required="true" required="">
                            </fieldset>

                            <fieldset class="password">
                                <div class="body-title mb-10">Password <span class="tf-color-1">*</span></div>
                                <input class="password-input" type="password" placeholder="Enter your password" name="password" tabindex="0" value="{{old('password')}}" aria-required="true" required="">
                            ...
                            <fieldset>
                                ...
                                <div class="upload-image flex-grow mt-5">
                            ...
                            {{-- <fieldset class="password">
                                ...
                                <input class="password-input" type="password" placeholder="Enter your password" name="cpassword" tabindex="0" value="" aria-required="true" required="">
                                <span class="show-pass">
                                    <i class="icon-eye view"></i>
                                    <i class="icon-eye-off hide"></i>
                                </span>
                         ...
                         <button type="submit" name="register_btn" class="tf-button w-full">Sign Up</button>
                        </form>
