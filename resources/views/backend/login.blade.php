...
<head>
    ...
    <link rel="apple-touch-icon-precomposed" href="/backend/images/favicon.png">
    ...
    <div id="wrapper"> --}}
        ...
        <div id="page" class="">
            <div class="wrap-login-page">
                ...
                @endif
                        <form class="form-login flex flex-column gap24" action="/admin/login" method="post" >
                            @csrf
                            ...
                            <fieldset class="email">
                                ...
                                <input class="flex-grow" type="email" placeholder="Enter your email address" name="email" value="{{old('email')}}" tabindex="0" value="" aria-required="true" required>
                            </fieldset>


                            <fieldset class="password">
                                <div class="body-title mb-10">Password <span class="tf-color-1">*</span></div>
                                <input class="password-input" type="password" placeholder="Enter your password" name="password" value="{{old('password')}}" tabindex="0" value="" aria-required="true" required>
                        ...
                        <div class="body-text text-center">
                            ...
                            <a href="{{url('/signup')}}" class="body-text tf-color">Register Now</a>
                        </div>
                    </div>
                </div>
...
<script src="/backend/backend/js/jquery.min.js"></script>
<script src="/backend/backend/js/bootstrap.min.js"></script>
<script src="/backend/backend/js/bootstrap-select.min.js"></script>
<script src="/backend/backend/js/zoom.js"></script>
<script src="/backend/backend/js/apexcharts/apexcharts.js"></script>
<script src="/backend/backend/js/apexcharts/line-chart-1.js"></script>
<script src="/backend/backend/js/apexcharts/line-chart-2.js"></script>
<script src="/backend/backend/js/apexcharts/line-chart-3.js"></script>
<script src="/backend/backend/js/apexcharts/line-chart-4.js"></script>
<script src="/backend/backend/js/apexcharts/line-chart-5.js"></script>
<script src="/backend/backend/js/apexcharts/line-chart-6.js"></script>
<script src="/backend/backend/js/switcher.js"></script>
<script src="/backend/backend/js/theme-settings.js"></script>
<script src="/backend/backend/js/main.js"></script>
