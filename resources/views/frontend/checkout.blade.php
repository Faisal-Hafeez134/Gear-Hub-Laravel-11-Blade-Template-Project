                        ...
                        <form action="{{url('/checkouts')}}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mb-20">
                                    ...
                                    <input placeholder="House number and street name" type="text" name="address" value="{{old('address')}}" required>
                                </div>
                                {{-- <div class="col-12 mb-20">
                            ...
                            <div class="payment_method">
                                ...
                                <div class="panel-default">
                                    ...
                                    <label for="payment_defult" data-bs-toggle="collapse" data-bs-target="#collapsedefult"
                                        aria-controls="collapsedefult">PayPal <img src="frontend/img/icon/papyel.png"
                                            alt=""></label>
                                ...
                                <div class="order_button">
                                    <button type="submit"  name="checkout" >Proceed to PayPal</button>
                                </div>
                            </div>
                        </form>
                    </div>
