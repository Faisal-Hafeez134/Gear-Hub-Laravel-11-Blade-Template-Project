            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <article class="single_gallery_section">
                        <figure>
                            <div class="gallery_thumb">
                                <img src="frontend/img/about/about3.jpg" alt="">
                            </div>
                            <figcaption class="about_gallery_content">
                                <h3>History Of Us</h3>
                                <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4">
                    <div class="single_chose">
                        <div class="chose_icone">
                            <img src="frontend/img/about/About_icon1.png" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="single_chose">
                        <div class="chose_icone">
                            <img src="frontend/img/about/About_icon2.png" alt="">
                        </div>
                        <div class="chose_content">
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="single_chose">
                        <div class="chose_icone">
                            <img src="frontend/img/about/About_icon3.png" alt="">
                        </div>
                        <div class="chose_content">
                            <h3>High Quality</h3>
                            <p>Erat metus sodales eget dolor consectetuer, porta ut purus at et alias, nulla ornare
            ...
            <div class="row">
                    ...
                    <article class="team_member">
                        <figure>
                            <div class="team_thumb">
                                <img src="frontend/img/about/about-us-person1.png" alt="">
                            </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <article class="team_member">
                        <figure>
                            <div class="team_thumb">
                                <img src="frontend/img/about/about-us-person2.png" alt="">
                            </div>
                            <figcaption class="team_content">
                                <h3>Mary</h3>
                                <h5>Designer</h5>
                ...
                <div class="col-lg-3 col-md-6">
                    <article class="team_member">
                        <figure>
                            <div class="team_thumb">
                                <img src="frontend/img/about/about-us-person3.png" alt="">
                            </div>
                            <figcaption class="team_content">
                                <h3>Michael</h3>
                                <h5>Developer</h5>
                ...
                <div class="col-lg-3 col-md-6">
                    <article class="team_member">
                        <figure>
                            <div class="team_thumb">
                                <img src="frontend/img/about/about-us-person4.png" alt="">
                            </div>
                            <figcaption class="team_content">
                                <h3>James</h3>
                                <h5>Coder</h5>
