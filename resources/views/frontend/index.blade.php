        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-3">
                    <div class="single_banner mb-30">
                        <div class="banner_thumb">
                            <a href="{{url('/shop')}}"><img src="frontend/img/bg/banner1.jpg" alt=""></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    <div class="single_banner mb-30">
                        <div class="banner_thumb">
                            <a href="{{url('/shop')}}"><img src="frontend/img/bg/banner2.jpg" alt=""></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3">
                    <div class="single_banner mb-30">
                        <div class="banner_thumb">
                            <a href="{{url('/shop')}}"><img src="frontend/img/bg/banner3.jpg" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <article class="single_product">
                    <figure>
                        ...
                        <div class="product_thumb">
                            ...
                            <a class="secondary_img" href="{{url('/product-details'.$work->id)}}">
                                <img src="{{ url($work->image2) }}" alt=""></a>
                        ...
                        <figcaption class="product_content">
                            ...
                            <h3 class="product_name"><a href="{{url('/product-details'.$work->id)}}">{{ $work->product_name }}</a></h3>
                        </figcaption>
                    </figure>
                </article>
                @endforeach
                ...
                {{-- <article class="single_product">
                    <figure>
                        ...
                        <figcaption class="product_content">
                            ...
                            <h3 class="product_name"><a href="{{url('/product-details'.$work->id)}}">Itaque earum velit elementum</a>
                            </h3>
                        </figcaption>
                    </figure>
                </article>
                <article class="single_product">
                    <figure>
                        ...
                        <figcaption class="product_content">
                            ...
                            <h3 class="product_name"><a href="{{url('/product-details'.$work->id)}}">Mauris tincidunt eros posuere
                                    placerat</a></h3>
                        </figcaption>
                    </figure>
                </article>
                <article class="single_product">
                    <figure>
                        ...
                        <figcaption class="product_content">
                            ...
                            <h3 class="product_name"><a href="{{url('/product-details'.$work->id)}}">Morbi ornare vestibulum massa</a>
                            </h3>
                        </figcaption>
                    </figure>
                </article>
                <article class="single_product">
                    <figure>
                        ...
                        <figcaption class="product_content">
                            ...
                            <h3 class="product_name"><a href="{{url('/product-details'.$work->id)}}">Porro quisquam eget feugiat
                                    pretium</a></h3>
                        </figcaption>
                    </figure>
                </article>
                <article class="single_product">
                    <figure>
                        ...
                        <figcaption class="product_content">
                            ...
                            <h3 class="product_name"><a href="{{url('/product-details'.$work->id)}}">Laudantium enim fringilla
                ...
                <article class="single_product">
                    <figure>
                        ...
                        <figcaption class="product_content">
                            ...
                            <h3 class="product_name"><a href="{{url('/product-details'.$work->id)}}">Natus erro at congue massa commodo
                                    sit</a></h3>
                        </figcaption>
                    </figure>
                </article> --}}
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="single_banner mb-30">
                        <div class="banner_thumb">
                            <a href="{{url('/shop')}}"><img src="frontend/img/bg/banner4.jpg" alt=""></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    <div class="single_banner mb-30">
                        <div class="banner_thumb">
                            <a href="{{url('/shop')}}"><img src="frontend/img/bg/banner5.jpg" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="top_category_container category_column5 owl-carousel">
                            ...
                            <article class="single_category">
                                <figure>
                                    <div class="category_thumb">
                                        <a href="{{url('/shop')}}"><img src="{{url($work->image)}}" alt=""></a>
                                    </div>
                                    <figcaption class="category_name">
                                        <h3><a href="{{url('/shop')}}">{{$work->category_name}} </a></h3>
                                    </figcaption>
                                </figure>
                            </article>
                        </div>
                        ...
                        {{-- <div class="col-lg-2">
                            <article class="single_category">
                                <figure>
                                    <div class="category_thumb">
                                        <a href="{{url('/shop')}}"><img src="frontend/img/s-product/category2.jpg" alt=""></a>
                                    </div>
                                    <figcaption class="category_name">
                        ...
                        <div class="col-lg-2">
                            <article class="single_category">
                                <figure>
                                    <div class="category_thumb">
                                        <a href="{{url('/shop')}}"><img src="frontend/img/s-product/category3.jpg" alt=""></a>
                                    </div>
                                    <figcaption class="category_name">
                        ...
                        <div class="col-lg-2">
                            <article class="single_category">
                                <figure>
                                    <div class="category_thumb">
                                        <a href="{{url('/shop')}}"><img src="frontend/img/s-product/category4.jpg" alt=""></a>
                                    </div>
                                    <figcaption class="category_name">
                        ...
                        <div class="col-lg-2">
                            <article class="single_category">
                                <figure>
                                    <div class="category_thumb">
                                        <a href="{{url('/shop')}}"><img src="frontend/img/s-product/category5.jpg" alt=""></a>
                                    </div>
                                    <figcaption class="category_name">
            ...
            <div class="row featured_container featured_column3">
                ...
                <div class="col-lg-4">
                    ...
                    <article class="single_product">
                        <figure>
                            <div class="product_thumb">
                                <a class="primary_img" href="{{url('/product-details')}}"><img
                                        src="frontend/img/product/product13.jpg" alt=""></a>
                                <a class="secondary_img" href="{{url('/product-details')}}"><img
                            ...
                            <figcaption class="product_content">
                                ...
                                <h3 class="product_name"><a href="{{url('/product-details')}}">Pellentesque posuere hendrerit
                                        dui</a></h3>
                                <div class="add_to_cart">
                                    <a href="{{url('/cart')}}" title="add to cart">Add to cart</a>
                                </div>
                    ...
                    <article class="single_product">
                        <figure>
                            ...
                            <figcaption class="product_content">
                                ...
                                <h3 class="product_name"><a href="{{url('/product-details')}}">Auctor gravida enim pellentesque
                                        quam</a></h3>
                                <div class="add_to_cart">
                                    <a href="{{url('/cart')}}" title="add to cart">Add to cart</a>
                                </div>
                    ...
                    <article class="single_product">
                        <figure>
                            ...
                            <figcaption class="product_content">
                                ...
                                <h3 class="product_name"><a href="{{url('/product-details')}}">Kaoreet lobortis sagittis
                                        pellentesque</a></h3>
                                <div class="add_to_cart">
                                    <a href="{{url('/cart')}}" title="add to cart">Add to cart</a>
                                </div>
                    ...
                    <article class="single_product">
                        <figure>
                            ...
                            <figcaption class="product_content">
                                ...
                                <h3 class="product_name"><a href="{{url('/product-details')}}">Cras neque honcus consectetur
                                        magna</a></h3>
                                <div class="add_to_cart">
                                    <a href="{{url('/cart')}}" title="add to cart">Add to cart</a>
                                </div>
                    ...
                    <article class="single_product">
                        <figure>
                            ...
                            <figcaption class="product_content">
                                ...
                                <h3 class="product_name"><a href="{{url('/product-details')}}">Duis pulvinar obortis eleifend
                                        elementum</a></h3>
                                <div class="add_to_cart">
                                    <a href="{{url('/cart')}}" title="add to cart">Add to cart</a>
                                </div>
                    ...
                    <article class="single_product">
                        <figure>
                            ...
                            <figcaption class="product_content">
                                ...
                                <h3 class="product_name"><a href="{{url('/product-details')}}">Fusce ultricies dolor vitae
                    ...
                    <article class="single_product">
                        <figure>
                            ...
                            <figcaption class="product_content">
                                ...
                                <h3 class="product_name"><a href="{{url('/product-details')}}">Natus erro at congue massa
                                        commodo sit</a></h3>
                                <div class="add_to_cart">
                                    <a href="{{url('/cart')}}" title="add to cart">Add to cart</a>
                                </div>
...
@foreach ($Computer as $comp)
                ...
                <article class="single_product">
                    ...
                    <figure>
                        <div class="product_thumb">
                            <a class="primary_img" href="{{url('/product-details'.$comp->id)}}"><img
                                    src="{{$comp->image1}}" alt=""></a>
                            {{-- <a class="secondary_img" href="{{url('/product-details')}}"><img
                                    src="{{$comp->image1}}" alt=""></a> --}}
                            <div class="label_product">
                                <span class="label_sale">sale</span>
                        ...
                        <figcaption class="product_content">
                            <div class="price_box">
                                <span class="old_price">$86.00</span>
                                <span class="current_price">{{$comp->price}}</span>
                            </div>
                            <h3 class="product_name"><a href="{{url('/product-details'.$comp->id)}}">{{$comp->product_name}}
                                    </a></h3>
                        </figcaption>
                    </figure>
                </article>
                ...
                {{-- <article class="single_product">
                    <figure>
                        ...
                        <figcaption class="product_content">
                            ...
                            <h3 class="product_name"><a href="{{url('/product-details')}}">Itaque earum velit elementum</a>
                            </h3>
                        </figcaption>
                    </figure>
                </article>
                <article class="single_product">
                    <figure>
                        ...
                        <figcaption class="product_content">
                            ...
                            <h3 class="product_name"><a href="{{url('/product-details')}}">Mauris tincidunt eros posuere
                                    placerat</a></h3>
                        </figcaption>
                    </figure>
                </article>
                <article class="single_product">
                    <figure>
                        ...
                        <figcaption class="product_content">
                            ...
                            <h3 class="product_name"><a href="{{url('/product-details')}}">Morbi ornare vestibulum massa</a>
                            </h3>
                        </figcaption>
                    </figure>
                </article>
                <article class="single_product">
                    <figure>
                        ...
                        <figcaption class="product_content">
                            ...
                            <h3 class="product_name"><a href="{{url('/product-details')}}">Porro quisquam eget feugiat
                                    pretium</a></h3>
                        </figcaption>
                    </figure>
                </article>
                <article class="single_product">
                    <figure>
                        ...
                        <figcaption class="product_content">
                            ...
                            <h3 class="product_name"><a href="{{url('/product-details')}}">Laudantium enim fringilla dignissim
                                    ipsum primis</a></h3>
                        </figcaption>
                    </figure>
                </article>
                <article class="single_product">
                    <figure>
                        ...
                        <figcaption class="product_content">
                            ...
                            <h3 class="product_name"><a href="{{url('/product-details')}}">Natus erro at congue massa commodo
                                    sit</a></h3>
                        </figcaption>
                    </figure>
                </article> --}}
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-9 col-md-9">
                    <div class="single_banner mb-30">
                        <div class="banner_thumb">
                            <a href="{{url('/shop')}}"><img src="frontend/img/bg/banner6.jpg" alt=""></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3">
                    <div class="single_banner mb-30">
                        <div class="banner_thumb">
                            <a href="{{url('/shop')}}"><img src="frontend/img/bg/banner7.jpg" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-9 col-md-12">
                    <div class="product_left_area">
                        ...
                        <div class="product_carousel product_column4 owl-carousel">
                            ...
                            @foreach ($smartphone_tablets as $work)
                            <article class="single_product">
                                <figure>
                                    <div class="product_thumb" style="width: 200px" style="height: 200px">
                            ...
                            {{-- <article class="single_product">
                                <figure>
                                    ...
                                    <figcaption class="product_content">
                                        ...
                                        <h3 class="product_name"><a href="{{url('/product-details')}}">Itaque earum velit
                                                elementum</a></h3>
                                    </figcaption>
                                </figure>
                            </article>
                            <article class="single_product">
                                <figure>
                                    ...
                                    <figcaption class="product_content">
                                        ...
                                        <h3 class="product_name"><a href="{{url('/product-details')}}">Mauris tincidunt eros
                            ...
                            <article class="single_product">
                                <figure>
                                    ...
                                    <figcaption class="product_content">
                                        ...
                                        <h3 class="product_name"><a href="{{url('/product-details')}}">Morbi ornare vestibulum
                                                massa</a></h3>
                                    </figcaption>
                                </figure>
                            </article>
                            <article class="single_product">
                                <figure>
                                    ...
                                    <figcaption class="product_content">
                                        ...
                                        <h3 class="product_name"><a href="{{url('/product-details')}}">Porro quisquam eget
                            ...
                            <article class="single_product">
                                <figure>
                                    ...
                                    <figcaption class="product_content">
                                        ...
                                        <h3 class="product_name"><a href="{{url('/product-details')}}">Laudantium enim
                            ...
                            <article class="single_product">
                                <figure>
                                    ...
                                    <figcaption class="product_content">
                                        ...
                                        <h3 class="product_name"><a href="{{url('/product-details')}}">Natus erro at congue
                    ...
                    <div class="testimonial_are">
                        ...
                        <div class="testimonial_active owl-carousel">
                            <article class="single_testimonial">
                                <figure>
                                    <div class="testimonial_thumb">
                                        <a href="#"><img src="frontend/img/about/testimonial1.jpg" alt=""></a>
                                    </div>
                            ...
                            <article class="single_testimonial">
                                <figure>
                                    <div class="testimonial_thumb">
                                        <a href="#"><img src="frontend/img/about/testimonial2.jpg" alt=""></a>
                                    </div>
                                    <figcaption class="testimonial_content">
                            ...
                            <article class="single_testimonial">
                                <figure>
                                    <div class="testimonial_thumb">
                                        <a href="#"><img src="frontend/img/about/testimonial3.jpg" alt=""></a>
                                    </div>
                                    <figcaption class="testimonial_content">
                ...
                <div class="blog_carousel blog_column4 owl-carousel">
                    ...
                    <div class="col-lg-3">
                        <article class="single_blog">
                            <figure>
                                <div class="blog_thumb">
                                    <a href="blog-details.html"><img src="frontend/img/blog/blog2.jpg" alt=""></a>
                                </div>
                                <figcaption class="blog_content">
                                    <p class="post_author">By <a href="#">admin</a> July 04, 2022</p>
                    ...
                    <div class="col-lg-3">
                        <article class="single_blog">
                            <figure>
                                <div class="blog_thumb">
                                    <a href="blog-details.html"><img src="frontend/img/blog/blog3.jpg" alt=""></a>
                                </div>
                                <figcaption class="blog_content">
                                    <p class="post_author">By <a href="#">admin</a> July 04, 2022</p>
                    ...
                    <div class="col-lg-3">
                        <article class="single_blog">
                            <figure>
                                <div class="blog_thumb">
                                    <a href="blog-details.html"><img src="frontend/img/blog/blog4.jpg" alt=""></a>
                                </div>
                                <figcaption class="blog_content">
                                    <p class="post_author">By <a href="#">admin</a> July 04, 2022</p>
                    ...
                    <div class="col-lg-3">
                        <article class="single_blog">
                            <figure>
                                <div class="blog_thumb">
                                    <a href="blog-details.html"><img src="frontend/img/blog/blog5.jpg" alt=""></a>
                                </div>
                                <figcaption class="blog_content">
                                    <p class="post_author">By <a href="#">admin</a> July 04, 2022</p>
