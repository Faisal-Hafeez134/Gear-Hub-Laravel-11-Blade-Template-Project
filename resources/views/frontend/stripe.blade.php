                    ...
                    <form
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <input placeholder="House number and street name" type="hidden" name="address" value="{{old('address')}}" >
                                <input type="hidden" name="fullname" value="{{old('fullname')}}" > --}}

                                <button class="btn btn-primary btn-lg btn-block" type="submit">Pay Now (PKR 200)</button>
                            </div>
                        </div>
