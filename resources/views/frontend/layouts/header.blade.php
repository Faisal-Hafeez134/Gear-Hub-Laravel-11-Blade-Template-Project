...
<head>
    ...
    <title>GearHub | @yield('title')</title>
                ...
                <div class="col-12">
                    ...
                    <div class="Offcanvas_menu_wrapper">
                        ...
                        <div class="support_info">
                            <p>Telephone Enquiry: <a href="tel:0123456789">03024067993</a></p>
                        </div>
                            ...
                            <form action="#">
                                <div class="hover_category">
                                    <select class="select_option" name="select" id="categori">
                                        ...
                                        <option value="2">Accessoriesss</option>
                        ...
                        <div class="middel_right_info">
                            <div class="header_wishlist">
                                <a href="{{ url('/wishlist') }}"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
                            ...
                            <div class="mini_cart_wrapper">
                                ...
                                <div class="mini_cart">
                                    ...
                                    <div class="cart_item">
                                        <div class="cart_img">
                                            <a href="#"><img src="frontend/img/s-product/product2.jpg" alt=""></a>
                                        </div>
                                        <div class="cart_info">
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-md-6">
                            <div class="logo">
                                <a href="{{ url('/') }}"><img src="frontend/img/logo/mainlogo.png" alt=""></a>
                            </div>
                        </div>
                            ...
                            <div class="main_menu menu_position">
                                <nav>
                                    <ul>
                                        ...
                                        <li class="mega_items"><a href="{{ url('/shop') }}">shop</a>
